...
def generate_mdmerge_rsp(rsp, windows_sdk_ref_dir, windows_app_sdk_dir, uwp_version):
    with open(rsp, 'w') as f:
        ...
        f.writelines(f'-metadata_dir "{path}\."\n' for path in windows_sdk_ref_dir.glob('*/*.*.*.*/'))
...
if __name__ == "__main__":
    ...
    generate_mdmerge_rsp(args.rspfile, windows_sdk_ref_dir, args.windows_app_sdk_dir, args.uwp_version)
