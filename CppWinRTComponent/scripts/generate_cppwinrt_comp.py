...
def generate_cppwinrt_comp_rsp(rsp, windows_sdk_ref_dir, windows_app_sdk_dir, uwp_version):
...
if __name__ == "__main__":
    ...
    generate_cppwinrt_comp_rsp(args.rspfile, windows_sdk_ref_dir, args.windows_app_sdk_dir, args.uwp_version)
